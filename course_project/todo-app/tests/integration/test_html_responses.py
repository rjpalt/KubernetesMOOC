...
class TestHTMLResponses:
    ...
    def test_root_endpoint_handles_backend_unavailable(self, test_client: TestClient, mock_todo_service, mock_image_service):
    ...
    def test_root_endpoint_backend_communication_architecture(self, test_client: TestClient, mock_todo_service, mock_image_service):
